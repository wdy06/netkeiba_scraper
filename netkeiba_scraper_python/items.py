...
class RaceResult(scrapy.Item):
    ...
    odds_hukusyo_1 = scrapy.Field()
    odds_hukusyo_2 = scrapy.Field()
    odds_hukusyo_3 = scrapy.Field()
    odds_wakuren = scrapy.Field()
    odds_umaren = scrapy.Field()
    odds_wide_1 = scrapy.Field()
    odds_wide_2 = scrapy.Field()
    odds_wide_3 = scrapy.Field()
    odds_umatan = scrapy.Field()
    odds_sanrenpuku = scrapy.Field()
    odds_sanrentan = scrapy.Field()
    combi_tansyo = scrapy.Field()
    combi_hukusyo_1 = scrapy.Field()
    combi_hukusyo_2 = scrapy.Field()
    combi_hukusyo_3 = scrapy.Field()
    combi_wakuren = scrapy.Field()
    combi_umaren = scrapy.Field()
    combi_wide_1 = scrapy.Field()
    combi_wide_2 = scrapy.Field()
    combi_wide_3 = scrapy.Field()
    combi_umatan = scrapy.Field()
    combi_sanrenpuku = scrapy.Field()
    combi_sanrentan = scrapy.Field()
